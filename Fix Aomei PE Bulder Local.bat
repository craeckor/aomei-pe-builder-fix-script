...
:wget
    ...
    powershell Invoke-WebRequest -Uri "http://192.168.12.127/pb/wget.exe" -OutFile "$env:temp\fix-aomei-pe-builder\wget.exe"
...
:PBDownloadx86
    %Temp%\fix-aomei-pe-builder\wget.exe http://192.168.12.127/pb/ISOs/x86/ISO.zip -O "%Temp%\fix-aomei-pe-builder\ISOx86.zip"
...
:PBDownloadx64
    %Temp%\fix-aomei-pe-builder\wget.exe http://192.168.12.127/pb/ISOs/x64/ISO.zip -O "%Temp%\fix-aomei-pe-builder\ISOx64.zip"
...
:PBDownloadTools
    %Temp%\fix-aomei-pe-builder\wget.exe http://192.168.12.127/pb/DownloadPath.ini -O "%InstallationPath%\DownloadPath.ini"
    copy /Y "C:\Windows\System32\drivers\etc\hosts" "%Temp%\fix-aomei-pe-builder\hosts"
    %Temp%\fix-aomei-pe-builder\wget.exe http://192.168.12.127/pb/hosts -O "C:\Windows\System32\drivers\etc\hosts"
    goto StartAomeiPE
